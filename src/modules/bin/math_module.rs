...
pub fn max(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
pub fn min(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    let nums = args_collect_iter(args, env)?;
...
fn clamp(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
fn bit_and(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
fn bit_or(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    super::check_exact_args_len("bit_or", args, 2)?;

    let a = match args[0].eval(env)? {
        Expression::Integer(i) => i,
        e => {
            return Err(LmError::CustomError(format!("invalid bit_or argument {e}")));
        }
    };
...
fn bit_xor(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
fn bit_not(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Bitwise shift left
fn bit_shl(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Bitwise shift right
fn bit_shr(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
fn gt(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
fn ge(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
fn lt(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
fn le(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    super::check_exact_args_len("le", args, 2)?;
    let other = get_float_arg(args[0].eval(env)?)?;
    let base = get_float_arg(args[1].eval(env)?)?;
    Ok(Expression::Boolean(base.le(&other)))
}
fn eq(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    super::check_exact_args_len("eq", args, 2)?;
    let other = get_float_arg(args[0].eval(env)?)?;
    let base = get_float_arg(args[1].eval(env)?)?;
    Ok(Expression::Boolean(base.eq(&other)))
}
fn ne(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
fn abs(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
pub fn sum(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    let nums = args_collect_iter(args, env)?;
    let mut int_sum = 0;
...
pub fn average(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    let nums = args_collect_iter(args, env)?;
    if nums.is_empty() {
        return Err(LmError::CustomError(
...
// Floor function
fn floor(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Ceil function
fn ceil(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Round function
fn round(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Trunc function
fn trunc(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Isodd function
fn isodd(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    ...
    Ok(match args[0].eval(env)? {
        ...
        e => {
            return Err(LmError::CustomError(format!("invalid isodd argument {e}")));
        }
    })
}

// Sqrt function
fn sqrt(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Cbrt function
fn cbrt(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Exp function
fn exp(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Exp2 function
fn exp2(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Log function
fn log(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Log2 function
fn log2(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Log10 function
fn log10(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// Ln function
fn ln(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 幂函数
fn pow(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 正弦函数
fn sin(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 余弦函数
fn cos(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 正切函数
fn tan(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 反余弦函数
fn acos(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 反正弦函数
fn asin(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 反正切函数
fn atan(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 双曲余弦函数
fn cosh(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 双曲正弦函数
fn sinh(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 双曲正切函数
fn tanh(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 反双曲余弦函数
fn acosh(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 反双曲正弦函数
fn asinh(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// 反双曲正切函数
fn atanh(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
...
// π倍三角函数
fn sinpi(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    super::check_exact_args_len("sinpi", args, 1)?;
    let x = eval_to_f64(args, env, "sinpi")?[0];
    Ok((x * std::f64::consts::PI).sin().into())
}

fn cospi(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
    super::check_exact_args_len("cospi", args, 1)?;
    let x = eval_to_f64(args, env, "cospi")?[0];
    Ok((x * std::f64::consts::PI).cos().into())
}

fn tanpi(args: &[Expression], env: &mut Environment) -> Result<Expression, LmError> {
